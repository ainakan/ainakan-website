For the impatient, here's how to do function tracing with Ainakan:

{% highlight bash %}
~ $ pip install ainakan-tools
~ $ ainakan-trace -i "recv*" -i "read*" twitter
...
So as you can see, Ainakan injected itself into Twitter, enumerated the loaded
...
{% highlight js %}
/*
 * Auto-generated by Ainakan. Please modify to match the
 * signature of recvfrom.
 *
 * This stub is somewhat dumb. Future verions of Ainakan
 * could auto-generate based on OS API references, manpages,
 * etc. (Pull-requests appreciated!)
 *
 * For full API reference, see:
 * https://ainakan.re/docs/javascript-api/
 */
...
own tools using the Python API that [ainakan-trace][] is built on top of.

[ainakan-trace]: https://github.com/ainakan/ainakan-tools/blob/main/ainakan_tools/tracer.py
