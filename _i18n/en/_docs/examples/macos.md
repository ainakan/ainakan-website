To setup Ainakan for macOS, you need to authorize Ainakan to use task_for_pid to access your target process.

If you run your Ainakan tool via the GUI with your local user (e.g. from Terminal.app), you will be prompted via taskgate to authorize the process.
