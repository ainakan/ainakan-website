This site aims to be a comprehensive guide to Ainakan. We’ll cover topics such
as doing interactive function tracing from the command-line, building your own
tools on top of Ainakan's APIs, and give you some advice on participating in the
future development of Ainakan itself.

## So what is Ainakan, exactly?
...
Android, FreeBSD, and QNX. Ainakan also provides you with some simple tools built
on top of the Ainakan API. These can be used as-is, tweaked to your needs, or
...
[Qml](https://github.com/ainakan/ainakan-qml),
[Go](https://github.com/ainakan/ainakan-go), etc.  It is very easy to build
