Ainakan CLI is a REPL interface that aims to emulate a lot of the nice
features of IPython (or Cycript), which tries to get you closer to
your code for rapid prototyping and easy debugging.

{% highlight bash %}
# Connect Ainakan to an iPad over USB and start debugging Safari
$ ainakan -U Safari
...
{% highlight bash %}
# Connect Ainakan to a locally-running Calculator.app and load calc.js
