Ainakan was born after [@oleavr][] and [@hsorbo][] had been casually
...
itches, [@oleavr][] started piecing together [ainakan-gum][], a generic
...
further improved and used to create Ainakan. The component [ainakan-core][] would
...
code running inside those processes. Inside that payload, [ainakan-gum][] would
...
to [ainakan-gum][]'s code tracing engine, the so-called [Stalker][]. There were
...
Today, Ainakan should be a very helpful toolbox for anyone interested in dynamic
...
also possible to use Ainakan from C.
...
[ainakan-gum]: https://github.com/ainakan/ainakan-gum
[Stalker]: https://github.com/ainakan/ainakan-gum/blob/master/gum/backend-x86/gumstalker-x86.c
[huge improvements]: http://blog.kalleberg.org/post/833101026/live-x86-code-instrumentation-with-ainakan
...
[Qt/Qml]: https://github.com/ainakan/ainakan-qml
[Go]: https://github.com/ainakan/ainakan-go
