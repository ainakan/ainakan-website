...
If you've ever used Ainakan to spawn programs making use of stdio you might have
...
the data being written to *stdout* and *stderr*. Ainakan's CLI tools get this
for free as this is [wired up](https://github.com/ainakan/ainakan-python/blob/4afd9debd489e3920b85cb6c542de10aabb0dcce/src/ainakan/application.py#L212)
...
- ainakan-trace: flush queued events before exiting

7.1.5:

- ainakan-repl: improve REPL autocompletion
...
- ainakan-server: always recycle the same temporary directory
...
- core: provide a proper error message when the remote Ainakan is incompatible
...
- ainakan-repl: monitor the loaded script and auto-reload on change
...
- ainakan-repl: add *--no-pause* to not pause spawned process at startup
