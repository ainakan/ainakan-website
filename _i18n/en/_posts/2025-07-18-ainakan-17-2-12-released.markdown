---
layout: news_item
title: 'Ainakan 17.2.12 Released'
...
We're excited to announce Ainakan 17.2.12, which brings preliminary support for
...
- android: Bumped `ainakan-java-bridge` in `system-server` to include a fix
  ...
  **Massive thanks to [@AeonLucid][] for spearheading this work — a truly
  heroic effort that brings rock-solid reliability to Ainakan’s Android support
  in the face of ever-changing ART internals.**

- gum: Added preliminary support for running without an operating system,
  enabling Ainakan to run on bare-metal targets. The integrator overrides the
