...
The Ainakan co-conspirators have been cracking away on several fronts, so much
...
On my end I have been applying Ainakan to interesting challenges at
...
[been fixed](https://github.com/ainakan/ainakan-gum/commit/2f02e911edc4a5df80051fdaed72e0281ea751e7).
...
- ainakan-discover: fix regression
- ainakan-repl: fix hang when target crashes during evaluation of expression
...
- ainakan-repl: add *%time* command for easy profiling
...
- ainakan-repl: improved completion
...
- ainakan-repl: better magic commands
