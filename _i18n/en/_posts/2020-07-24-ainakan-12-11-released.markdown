...
In anticipation of Apple releasing macOS 11, it's time for Ainakan 12.11! This
...
The workaround is simple though – just grab a ainakan-server binary from our
...
- Fix infinite wait when i/macOS ainakan-helper dies early.
...
- qml: Sync DetachReason enum with the current Ainakan API.
...
- Improve the ainakan-qml build system and add support for standalone use.
...
- Build GumJS runtime for V8 without compression for now, as we need to improve
  ainakan-compile to use the latest version of [terser][].

### Changes in 12.11.14

- Build GumJS runtime for V8 with compression now that ainakan-compile has been
...
[CryptoShark 0.2.0]: https://github.com/ainakan/cryptoshark/releases/tag/0.2.0
