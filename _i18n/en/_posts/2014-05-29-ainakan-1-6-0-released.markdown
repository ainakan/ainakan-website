...
As some of you may have noticed, Ainakan recently got brand new Android support,
...
that code was doing. You could of course use Ainakan's FFI API to poke your way
into the VM, but hey, shouldn't Ainakan just do that dirty plumbing for you?
Of course it should!
...
`Dalvik.use()` with a given class name, Ainakan will interrogate the VM and
