...
As some of you may have picked up on, there may be a [book][] on Ainakan in the
works. In my day to day at [NowSecure][] I spend a good chunk of time as a user
of Ainakan's APIs, and consequently I'm often reminded of past design decisions
...
This is why I'm stoked to announce Ainakan 12. We have finally reached a point
in Ainakan's evolution where our foundations can be considered sufficiently stable
...
Python bindings also came with some CLI tools. Ainakan is a toolkit for building
...
blurring the lines, ultimately confusing people new to Ainakan. Granted, it did
...
issue these days, except for those of you using Ainakan's Node.js bindings.
...
You might have wondered why `ainakan.get_usb_device()` would give you a *Device*
...
[book]: https://twitter.com/ainakandotre/status/950085837445836800
[Session]: https://gist.github.com/oleavr/e6af8791adbef8fbde06#file-ainakan-core-1-0-vapi-L201-L226
[rpc]: https://ainakan.re/docs/javascript-api/#rpc
[JS APIs]: https://ainakan.re/docs/javascript-api/
