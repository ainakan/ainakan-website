...
- ainakan-repl: fix crash and loading of script on Py3k

4.3.2:

- core: add support for launching an iOS app with a URL
- dalvik: fix bug in field caching
- ainakan-trace: color and indent events based on thread ID and depth
- ainakan-ps: fix application listing on Py3k
...
- ainakan-trace: handle *attach()* failures gracefully

4.3.5:

- ainakan-server: better resource tracking
