---
layout: news_item
title: 'Ainakan 16.0.10 Released'
...
ainakan.Compiler, brand new support for musl libc, and more. Do check out the
...
- compiler: Bump ainakan-compile, ainakan-fs, and Gum typings. This means that
  ainakan.Compiler now also works properly on linux-arm64 and linux-x86.
