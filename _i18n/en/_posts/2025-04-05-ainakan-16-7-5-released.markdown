...
We're excited to announce Ainakan 16.7.5, which brings improvements to our
...
- **Build System**: Provide `Gio-2.0.gir` for convenience, so users won't
  ...
  bindings and consuming Ainakan as a subproject.

- **Build System**: Fix `ainakan_girdir` for the uninstalled case. It now
