...
- The remainder of Ainakan's internals have been migrated from udis86 to
...
- `Process.enumerateThreads()` omits Ainakan's own threads so you don't have to
  worry about them.

- Python 3 binaries are now built against Python 3.4.

So with this release out, let's talk about [CryptoShark](https://github.com/ainakan/cryptoshark):

<iframe width="560" height="315" src="//www.youtube.com/embed/hzDsxtcRavY?rel=0" frameborder="0" allowfullscreen></iframe>

Grab a pre-built Windows binary [here](https://build.ainakan.re/ainakan/windows/Win32-Release/bin/cryptoshark-0.1.1.exe),
