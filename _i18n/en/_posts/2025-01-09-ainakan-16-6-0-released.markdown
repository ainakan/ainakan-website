...
Pleased to announce Ainakan 16.6.0, featuring significant improvements to module
symbol handling, performance enhancements, and bug fixes.

Here are the highlights:

- **android**: Improve ART compatibility:
  - Look for symbols when exports are missing, now that Ainakan supports parsing
    `.gnu_debugdata`.
