...
- core: improve QNX support
- ainakan-repl: tweak the startup message
...
- core: fix early crash in AinakanGadget.dylib on iOS when running with
        *ios-deploy* and other environments where we are loaded before
        *CoreFoundation*
- core: run a *CFRunLoop* in the main thread of *ainakan-helper* on Darwin,
...
- core: spin the main CFRunLoop while AinakanGadget.dylib is blocking waiting for
