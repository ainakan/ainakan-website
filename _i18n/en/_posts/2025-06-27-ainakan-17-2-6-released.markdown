...
We're excited to announce Ainakan 17.2.6, featuring two important fixes:
...
- **agent**: Disable Exceptor for the emulated realm.
  ...
  `ainakan-server` or `ainakan-inject` on Android 14 and 15 AVDs.
