---
layout: news_item
title: 'Ainakan 16.0.19 Released'
...
- darwin: Make spawn() aware of the [prewarm][] feature used on iOS >= 15. What
  ...
  to save some startup time. This was in the way of Ainakan's spawn mechanism
  because:
  ...
  - Ainakan needs to spawn a fresh process to ensure early instrumentation
