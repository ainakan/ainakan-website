...
applications that fork are single-threaded, Ainakan effectively makes them
...
some data to Ainakan's *send()* API, and if the process is about to terminate,
...
*disable_child_gating()*. By default Ainakan will behave just like before, and
...
Ainakan's Python bindings:

{% highlight python %}
import ainakan
from ainakan.application import Reactor
import threading
...
Ainakan will now intercept the most common process termination APIs and take
...
Building on the brand new *fork()*-handling in Ainakan, there is also a fully
reworked Android app launching implementation. The *ainakan-loader-{32,64}.so*
...
[example]: https://github.com/ainakan/ainakan-python/blob/c846da1191e50e017235f29580c737f5b8555d9a/examples/child_gating.py
