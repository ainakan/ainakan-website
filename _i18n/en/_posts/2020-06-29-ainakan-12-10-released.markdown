...
[ainakan-java-bridge][] now supports the HotSpot JVM. This means our Java
...
We've also enhanced ainakan-trace to support Java method tracing:
...
This was just released as part of [ainakan-tools][] 8.0 – which you may grab
through e.g.: `pip3 install -U ainakan-tools`
...
[ainakan-tools]: https://github.com/ainakan/ainakan-tools
