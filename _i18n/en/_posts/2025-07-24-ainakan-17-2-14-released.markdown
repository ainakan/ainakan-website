---
layout: news_item
title: 'Ainakan 17.2.14 Released'
...
- **android:** Updated `ainakan-java-bridge` in `system-server` to include the
  improved ART offset lookup by [@AeonLucid][]. See [ainakan-java-bridge#362][]
  for details.

- **cloak:** Added support for `Art::GetOsThreadStat` on Android, addressing an
  issue similar to [ainakan-core#500][], where Zygote waits for the process to
...
- **compiler:** Bumped `@types/ainakan-gum` to 19.0.1.


[@AeonLucid]: https://x.com/AeonLucid
[ainakan-java-bridge#362]: https://github.com/ainakan/ainakan-java-bridge/pull/362
[ainakan-core#500]: https://github.com/ainakan/ainakan-core/issues/500
