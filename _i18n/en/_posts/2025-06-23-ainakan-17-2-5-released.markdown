...
This release brings important fixes and improvements to Ainakan. Here are the
highlights:

- ainakan-node: Keep TSFN alive until promise settles, preventing a race condition
...
- ainakan-node: Simplify `findMatchingDevice()` (co-authored by [@hsorbo][]).
