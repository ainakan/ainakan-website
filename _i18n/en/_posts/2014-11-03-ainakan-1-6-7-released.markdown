...
Tired of waiting for Ainakan to attach to 32-bit processes on 64-bit Mac
or iOS systems? Or perhaps `ainakan-trace` takes a while to resolve functions?
...
`ainakan-trace` and waiting for it to resolve functions.
