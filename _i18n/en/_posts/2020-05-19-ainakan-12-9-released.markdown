...
coalescing operator][] without having to [ainakan-compile][] your agent. That, and
...
- iOS usbmux pairing record plist parsing now also handles binary plists,
  fixing a long-standing issue where Ainakan would reject a tethered iOS USB
...
- The ainakan-core Vala API bindings are no longer missing the *ainakan.Error* type.
...
[what other functions does this function call]: https://codeshare.ainakan.re/@oleavr/who-does-it-call/
[Here]: https://github.com/ainakan/ainakan-presentations/blob/master/R2Con2017/02-transforms/06-return-values.js
