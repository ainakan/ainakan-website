...
How is this implemented you ask? That's the cool part. Ainakan already uses the
...
[JavaScript API Reference](https://ainakan.re/docs/javascript-api/) for all
the details.
