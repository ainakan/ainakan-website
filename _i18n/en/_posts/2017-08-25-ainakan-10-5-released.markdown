...
But first a little background. Most people using Ainakan are probably using the
...
basic blocks and then using Ainakan to put single-shot probes all over the place.
...
project. A lot of fun, but other parts of Ainakan received most of my attention
...
[fun pair-programming sessions]: http://blog.kalleberg.org/post/833101026/live-x86-code-instrumentation-with-ainakan
...
[SQLite API]: https://ainakan.re/docs/javascript-api/#sqlitedatabase
