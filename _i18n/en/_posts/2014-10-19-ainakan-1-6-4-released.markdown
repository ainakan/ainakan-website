...
Also, [CryptoShark 0.1.2](https://github.com/ainakan/cryptoshark) is out,
with an upgraded Ainakan engine and lots of performance improvements so the GUI
