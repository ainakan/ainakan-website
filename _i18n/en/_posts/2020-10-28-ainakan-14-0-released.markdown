...
- Language feature support being wildly different between the two runtimes.
  ...
  terms of features.
- Needing to sacrifice performance when using a tool such as [ainakan-compile][]
...
The next thing I was curious about was the approximate initial size of Ainakan's
internal heap when using our REPL. That includes all of the memory used by
ainakan-agent, the JS runtime, and the REPL agent that was loaded:
...
If you'd like to build Ainakan yourself with the V8 runtime enabled, it's only a
...
That's all in Ainakan itself, but there's more.  We've also released ainakan-tools
9.0, freshly upgraded to make use of modern JavaScript features everywhere. That
includes ainakan-trace, where the generated boilerplate hooks have become a lot
more readable after some syntax upgrades.  Last but not least we have also
released ainakan-compile 10.0, where the Babel dependencies are gone and so are
...
- qml: Update to the new ainakan-core API.
...
[test-suite]: https://github.com/ainakan/ainakan-gum/blob/6873f1504e40ad1a8bbc51d469c95519a2076fb0/tests/gumjs/script.c
[ScriptBackend]: https://github.com/ainakan/ainakan-gum/blob/6873f1504e40ad1a8bbc51d469c95519a2076fb0/bindings/gumjs/gumscriptbackend.h
[Script]: https://github.com/ainakan/ainakan-gum/blob/6873f1504e40ad1a8bbc51d469c95519a2076fb0/bindings/gumjs/gumscript.h
[QuickJS multi-threading API]: https://github.com/ainakan/quickjs/commit/7ec1392b19bcf6ae2b109cda3e2133c5d6918a6c
[done]: https://github.com/ainakan/ainakan-gum/commit/c47c0711c72a87e729e3e59110b7f611ff392fe2
[test]: https://github.com/ainakan/ainakan-gum/blob/6873f1504e40ad1a8bbc51d469c95519a2076fb0/tests/gumjs/script.c#L5089-L5137
[baseline memory usage]: https://github.com/ainakan/ainakan-gum/blob/6873f1504e40ad1a8bbc51d469c95519a2076fb0/tests/gumjs/script.c#L7356-L7399
[this line]: https://github.com/ainakan/ainakan/blob/b5aa3aa623c2d919e7fe7c34eee9ded31da8212e/config.mk#L22
