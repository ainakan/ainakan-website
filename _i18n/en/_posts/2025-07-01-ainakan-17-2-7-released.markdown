...
We're excited to announce the release of Ainakan 17.2.7, featuring significant
...
- **meson**: Clarify Vala build system instructions. The Vala README only
  ...
  `-ainakan` suffix is not added to the version string, causing the ainakan-core
