...
Let's talk about iOS kernel introspection. It's been a while since Ainakan got
...
- Ainakan is able to get a send right to the kernel task, either by traditional
...
log and figure out what you (or Ainakan) did wrong. Remember: the Kernel is always
right!

### Problem: I unrecoverably damaged my device using Ainakan Kernel APIs
