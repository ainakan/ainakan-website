...
Excited to announce Ainakan 17.1.4, which brings several important fixes and
...
- **Android**: Bumped `ainakan-java-bridge` to 7.0.3 in the `system_server`
...
- **Darwin**: Bumped `ainakan-objc-bridge` to 8.0.5 in internal agents.
...
upgrade to ainakan-tools 14.1.2, also just released.
