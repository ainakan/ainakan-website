...
It's time for some big updates to Ainakan's [Gadget](/docs/gadget/).
...
configuration file. Because some apps may look for loaded libraries with "Ainakan"
