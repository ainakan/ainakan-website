...
In the meantime, and for those of you using Ainakan on Windows, we have just
implemented a [minimal user-mode driver][] that Ainakan now uses when it detects
that the kernel doesn't provide one. We leveraged [lwIP][] to also do Ethernet
and IPv6 entirely in user space. The result is that Ainakan can support CoreDevice
...
[minimal user-mode driver]: https://github.com/ainakan/ainakan-core/blob/31188db39a7c9ae24f640a34b3fdf701f4a93bb3/src/fruity/ncm.vala
