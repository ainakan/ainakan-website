...
There's also a new and exciting ainakan-tools release, 12.3.0, which upgrades
ainakan-trace with Swift tracing support, using the new ApiResolver:

{% highlight bash %}
$ ainakan-trace Xcode -y '*CoreDevice!*RemoteDevice*'
{% endhighlight %}
...
- compiler: Bump ainakan-compile to 16.4.1, and @types/ainakan-gum to 18.4.5.
...
- gumjs: Bump ainakan-swift-bridge to 2.0.7.
