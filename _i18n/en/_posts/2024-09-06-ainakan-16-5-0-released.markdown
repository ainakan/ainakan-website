...
You may have tried Ainakan's MemoryAccessMonitor API, but found the page
...
means that an arm64 version of Ainakan can inject into native arm64 processes, as
...
- java: Add preliminary support for OpenJDK 17 on Windows. Thanks
  [@FrankSpierings][]!
- meson: Add ainakan-netif to the public ainakan-core, so ainakan-core devkits include
  all needed symbols.
