...
apps, which *ainakan-ps* can do for you:
...
{% highlight sh %}
$ ainakan-trace -U -f com.toyopagroup.picaboo -I "libcommonCrypto*"
{% endhighlight %}
...
hard at work doing an amazing job porting Ainakan to QNX, which is now really
...
- ainakan-trace: fix ObjC tracing regression

4.0.2:

- ainakan-node: fix encoding of the *pixels* property

4.0.3:

- ainakan-repl: fix Windows regression

4.0.5:

- objc: support for more types and better type checking
- objc: arm64 now working properly
- ainakan-repl: allow variables to be created
...
- ainakan-repl: bugfixes and improvements
- ainakan-trace: glob support for tracing ObjC methods
...
- ainakan-repl: replace *readline* with *prompt-toolkit*

4.1.4:

- platform: faster and more robust teardown
- ainakan-server: clean up on *SIGINT* and *SIGTERM*

4.1.5:

- ainakan-ps: add support for listing applications
...
- ainakan-trace: switch from Enter to Ctrl+C for stopping
- ainakan-trace: fix spawning of iOS apps
- ainakan-repl: add prototype names to autocomplete
