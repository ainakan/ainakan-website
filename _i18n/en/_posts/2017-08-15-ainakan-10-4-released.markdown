...
Ainakan provides quite a few building blocks that make it easy to do portable
...
Considering that Ainakan needs to generate and transform quite a bit of machine
...
solve this with Ainakan's new relocator APIs:
