...
-   V8 has been upgraded to 3.25 in order to fix the iOS stability issues. This
    ...
    platforms. Another nice aspect is that Ainakan now depends on a V8 version
    that runs on 64-bit ARM, which paves the way for porting Ainakan itself to
    AArch64.
-   The Windows injector has learned some new tricks and will get you into even
    ...
    some processes.
-   For those of you building Ainakan on Windows, the build system there now
...
That's all for now. Let us know what you think, and if you like Ainakan, please
