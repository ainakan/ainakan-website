...
- **Darwin**: Bumped `ainakan-objc-bridge` to version 8.0.4.
- **Android**: Bumped `ainakan-java-bridge` to version 7.0.1.
- **ainakan-node**: Fixed the return type of `Device.openChannel()` to avoid
