---
layout: news_item
title: 'Ainakan 16.7.15 Released'
...
auto-generated, ensuring that API changes in ainakan-core are instantly reflected,
...
- *API*: Fixed up `AinakanBase` references in the `.gir` files.
